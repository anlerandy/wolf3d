...
/*   Updated: 2022/10/31 15:29:26 by alerandy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mlx_launcher(t_data *data)
{
	...
	mlx_hook(data->win, 2, 1L << 0, press, (void*)data);
	mlx_hook(data->win, 3, 1L << 1, release, (void*)data);
	mlx_hook(data->win, 17, 1L << 17, wolf_exit, NULL);
	mlx_loop(data->mlx);
}
...
void	set_img(t_data *data)
{
	...
	data->frame.img = ft_intset(data->frame.img, 0xff000000, data->win_w * data->win_h);
	...
	data->fade.img = ft_intset(data->fade.img, 0xff000000, data->win_w * data->win_h);
